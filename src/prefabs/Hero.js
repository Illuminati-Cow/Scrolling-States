...
class HurtState extends State {
    enter(scene, hero) {
        ...
        scene.cameras.main.shake(50, 0.025)
...
class SpinState extends State {
    enter(scene, hero) {
        ...
        hero.anims.play('swing-360').once('animationcomplete', () => {this.stateMachine.transition('idle')})
        scene.time.delayedCall(250, () => {scene.cameras.main.shake(20, 0.02)})
    }
}